...
<script type="text/javascript">
    ...
    function load_div_grid() {
        var p = {};
        $('#div_grid').load("<?php echo site_url('intro/ajax_get_grid') ?>", p);
        return false;
    }
    function grid_btn_del(id) {
        if (confirm('คุณต้องการลบข้อมูลรายการนี้ ใช่หรือไม่?')) {
            ...
            $.ajax({
                data: p,
                url: "<?php echo site_url('intro/ajax_delete') ?>",
                type: 'POST',
                dataType: 'json',
                success: function () {
                    load_div_grid();
    ...
    <div class="container">
        ...
        <div class="masthead-pad">
            ...
            <div class="masthead-text pull-right">
                ...
                <?php echo anchor('intro/news', "<i class='glyphicon glyphicon-plus'></i> เพิ่มรายการใหม่", array('class' => 'btn btn-outline btn-defualt btn-xs')); ?>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <?php echo form_open_multipart('intro/save', array('id' => 'myform', 'name' => 'frmMain', 'class' => 'form-horizontal', 'role' => 'form')); ?>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="name">ภาพ :</label>
                                <div class="controls">
                                    <input type="file" class="form-control" id = "name" name="userfile" style="width: 350px" value="<?php echo @$row['thumb_name']; ?>" />
                                    <small>**(ขนาดภาพ 880*340 px) ** ชื่อภาพต้องเป็นภาษาอังกฤษเท่านั้นและห้ามเว้นวรรค รองรับไฟล์ที่มีนามสกุล .gif,.jpg,.png ภาพจะถูกปรับอัตโนมัติ</small>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="name">URL(ถ้ามี ex : http://www.rmu.ac.th) :</label>
                                <div class="controls">
