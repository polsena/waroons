...
<html> 
    ...
    <body style="margin:0;padding:0; background:#fff; font-family: Arial, Verdana, Sans-Serif;"> 
        <link id="theme-style" rel="stylesheet" href="<?php echo base_url(); ?>assets/home/css/slider.css">
        <!-- it works the same with all jquery version from 1.x to 2.x -->
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/home/js/jquery-1.9.1.min.js"></script>
        <!-- use jssor.slider.mini.js (40KB) instead for release -->
        <!-- jssor.slider.mini.js = (jssor.js + jssor.slider.js) -->
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/home/js/jssor.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/home/js/jssor.slider.js"></script>
        <script>
        ...
        <div id="slider1_container" style="position: relative; width: 980px;
            ...
            <!-- Slides Container --> 
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 970px; height: 380px;
                 overflow: hidden;">
                 <?php
                 $this->db->limit('20');
                 $this->db->order_by('id', 'desc');
                 $slider = $this->db->get('tbslide')->result_array();
                 foreach ($slider AS $rs):
                     ?>
                    <div>

                        <?php if ($rs['url'] == '') { ?> 
                            <img u="image" src="<?php echo base_url(); ?>assets/upload/slider/<?php echo $rs['thumb_name'] . $rs['ext']; ?>" />
                        <?php } else { ?>
                            <a href ="<?php echo $rs['url']; ?>" target="_blank"><img u="image" src="<?php echo base_url(); ?>assets/upload/slider/<?php echo $rs['thumb_name'] . $rs['ext']; ?>" /></a>
                        <?php } ?>
                        <?php if ($rs['detail'] != '' || $rs['filetmp'] != '') { ?>
                            <a class="captionOrange" target="_blank" href="<?php echo base_url();?>detail/<?php echo $rs['id'];?>" style="position: absolute; top: 345px; left: 725px; width: 250px; height: 30px;">อ่านรายละเอียดเพิ่มเติม</a>
                        <?php } ?>
                    </div>
                <?php endforeach ?>
            ...
            <!-- Arrow Left -->
            <span u="arrowleft" class="jssora20l" style="top: 123px; left: 5px;">
            </span>
            <!-- Arrow Right -->
            <span u="arrowright" class="jssora20r" style="top: 123px; right: 5px;">
            </span>
